<template>
  ...
  <div>
      ...
      <c-form layout="horizontal" span="220" @submit.prevent="handleSubmit">
        ...
        <c-form-field label="Supplier Name">
          <c-form-input 
              v-validate="'required|min:3'" 
              v-model="form.supplierName" 
              :status="checkErrors('supplier name')" 
              name="supplier name" 
              value="" 
              :disabled="isDisabled"
              type="text">
          </c-form-input>
          <span class="form-help u-color-danger" v-if="!form.errors.has('supplierName')">{{ errors.first('supplier name') }}</span>
          <span class="form-help u-color-danger" v-text="form.errors.get('supplierName')" v-if="form.errors.has('supplierName')"></span>
        </c-form-field>
        ...
        <c-form-field label="Full Name">
          <c-form-input 
              ...
              :status="checkErrors('full name')" 
              name="full name" 
              value="" 
              type="text">
          </c-form-input>
          <span class="form-help u-color-danger" v-if="!form.errors.has('fullName')">{{ errors.first('full name') }}</span>
          <span class="form-help u-color-danger" v-text="form.errors.get('fullName')" v-if="form.errors.has('fullName')"></span>
        </c-form-field>

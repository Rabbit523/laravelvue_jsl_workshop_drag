...
import axios from 'axios';
	...
	export default {
    	...
    	methods: {
    		...
    		editThis(pageid){
      			...
      			this.$router.push('/clients/'+pageid+'/edit');
          ...
          ActiveorInActive: function (id, index){
          	...
          	this.handleSubmit('status', 'post', '/clients/status/', this.form.statusid, this.form.status, i, index);
          ...
          killIt: function (id, index){
          	...
          	this.handleSubmit('kill', 'get', '/clients/destroy/', this.form.statusid, this.form.status, i, index, p);
    	...
    	computed:{
		  ...
		  sortedItems() {
            ...
            var newSort = result.sort((a, b) => ascDesc * a['clientName'].localeCompare(b['clientName']));
    ...
    //         	console.log('hit1');
    //         	return result.sort((a, b) => ascDesc * a['clientName'].localeCompare(b['clientName']));

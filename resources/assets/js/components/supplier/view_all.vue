	...
	export default {
    	...
    	methods: {
			...
			editThis(pageid){
  				...
  				this.$router.push('/supplier/'+pageid+'/edit');

  			},

  			createNew(){

  				this.$router.push('/supplier/addnew');
          ...
          ActiveorInActive: function (id, index){
          	...
          	this.handleSubmit('status', 'post', '/supplier/status/', this.form.statusid, this.form.status, i, index);
          ...
          killIt: function (id, index){
          	...
          	this.handleSubmit('kill', 'get', '/supplier/destroy/', this.form.statusid, this.form.status, i, index, p);
